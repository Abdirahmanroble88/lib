class Doctor:
    ...
    def __str__(self):
        return f"{self.doctor_id:<4} {self.name:<20} {self.specialization:<15} {self.working_time:<10} {self.qualification:<20} {self.room_number}"
...
class DoctorManager:
    ...
    def format_dr_info(self, doctor):
        return f"{doctor.doctor_id:<4} {doctor.name:<20} {doctor.specialization:<15} {doctor.working_time:<10} {doctor.qualification:<20} {doctor.room_number}"
